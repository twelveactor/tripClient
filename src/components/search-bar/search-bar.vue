...
<script setup>
import useMainStore from '@/store/modules/mian.js';
...
const startDateStr = computed(() => formatMonthDay(startDates.value, "MM.DD"))
const endDateStr = computed(() => formatMonthDay(endDates.value, "MM.DD"))
